...
<details>
<summary>点击展开 Windows 部署详细步骤</summary>
...
<details>
<summary>点击展开 Linux 部署详细步骤</summary>
...
<details>
<summary>点击展开 GitHub Personal Access Token 获取步骤</summary>

| GitHub Personal Access Token |
| :---: |
| **1.** 登录 GitHub → Settings → Developer settings → Personal access tokens → Tokens (classic) |
| **2.** Generate new token (classic)，Note 任意填 |
| **3.** **Expiration 必须选 `No expiration`** |
| **4.** Select scopes: 仅勾选 **repo**（自动勾全） |
| **5.** Generate token，**保存** |
| 填入 `git_sync.ps1` / `git_sync.sh` 的 `github_token` |

</details>

<details>
<summary>点击展开 Cloudflare API Token 获取步骤</summary>

| Cloudflare API Token |
| :---: |
| **1.** 登录 Cloudflare → My Profile → API Tokens → Create Token → Create Custom Token |
| **2.** Token name 任意；Permissions: `Zone` → `DNS` → `Edit`；Zone Resources: 选择你的域名 |
| **3.** 点击 Continue to summary → Create Token |
| **4.** **保存 Token** |
| **5.** Zone ID 在域名概览页右侧“API”栏目复制 |
| 填入 `config.json` 的 `CF_API_TOKEN` 和 `CF_ZONE_ID` |

</details>

<details>
<summary>点击展开 WxPusher 微信通知获取步骤</summary>

| WxPusher 微信通知 |
| :---: |
| **1.** 访问 [WxPusher 后台](http://wxpusher.zjiecode.com/admin/)，微信扫码登录 |
| **2.** 左侧菜单“应用管理”→“应用信息”→“新增应用”，填写名称后创建 |
| **3.** 复制保存 **AppToken**（仅显示一次） |
| **4.** 左侧“关注应用”→微信扫码关注公众号 |
| **5.** 公众号菜单“我的”→“我的UID”获取 UID |
| 填入 `config.json` 的 `WXPUSHER_APP_TOKEN` 和 `WXPUSHER_UIDS` |
...
<details>
<summary>点击展开筛选模式与数量控制参数</summary>
...
<details>
<summary>点击展开 TCP 连接测试参数</summary>
...
<details>
<summary>点击展开微信通知（WxPusher）参数</summary>
...
<details>
<summary>点击展开 Cloudflare DNS 批量更新参数</summary>
...
<details>
<summary>点击展开节点数据源与获取配置</summary>
...
<details>
<summary>🔧 高级参数（可用性 / 带宽 / 纯净度 / 并发 / 重试）点击展开</summary>
...
<details>
<summary>📤 GitHub 推送与同步（点击展开）</summary>
...
<details>
<summary>☁️ Cloudflare DNS 更新（点击展开）</summary>
